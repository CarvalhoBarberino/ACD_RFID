...
method jukPlay() class jukMarkBrowse
	...
	//Criando a janela
	DEFINE MSDIALOG oDlgMark TITLE 'Títulos encontratos' FROM 000, 000  TO aMsAdvSize[6], aMsAdvSize[5] COLORS 0, 16777215 PIXEL
	oPanGrid := tPanel():New(001, 001, '', oDlgMark, , , , RGB(000,000,000), RGB(254,254,254), (aMsAdvSize[5]/2)-1, (aMsAdvSize[6]/2 - 1))
	oMarkBrowse:= FWMarkBrowse():New()
	oMarkBrowse:SetDescription("Selecione o título para alterar a data") //Titulo da Janela
